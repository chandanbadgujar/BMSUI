...
export default class Footer extends Component {
    render() {
        return (
            <div className='section sticky-footer bg-dark text-white'>
                <div className='container mt-4'>
                    <div className='row'>
                        ...
                        <div className="col-md-4">
                            Products
                            <hr />
                            <div className="line-height">Home Loan</div>
                            <div className="line-height">Personal Loan</div>
                            <div className="line-height">Education Loan</div>
                        </div>
                    </div>
                </div>
            </div>
